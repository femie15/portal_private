...
class Index extends Component
{
    ...
    {
        return Route::get('subjecttraits', static::class)
            ->name('subjecttraits')
            ->middleware('auth');
    }
    ...
    {
        return view('subjecttraits.index', [
            'subjecttraits' => $this->query()->paginate(),
        ]);
    }

    public function query()
    {
        $query = Subjecttrait::query();
    ...
    public function delete(Subjecttrait $subjecttrait)
    {
        $subjecttrait->delete();
    }
}
