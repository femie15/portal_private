...
function websdkready() {
  ...
  var API_KEY = "Wy7Obk9yT16Re_3FmCflBw";
  /**
   * NEVER PUT YOUR ACTUAL API SECRET IN CLIENT SIDE CODE, THIS IS JUST FOR QUICK PROTOTYPING
   * The below generateSignature should be done server side as not to expose your api secret in public
   * You can find an eaxmple in here: https://marketplace.zoom.us/docs/sdk/native-sdks/web/essential/signature
   */
  var API_SECRET = "QXVxdLzRr2KNUbxeaeyFfKbrm6IgjdSee1dx";

  // some help code, remember mn, pwd, lang to cookie, and autofill.

  // document.getElementById("display_name").value ="Phee join";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/video/cdn/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
